...
export function ExportSection({
  ...
  return (
    <>
      <Card className="shadow-sm">
        ...
        <CardContent className="space-y-3">
          ...
          >
            ...
            {isBusy ? t.export.syncing : t.export.googleCalendar}
          </Button>
          ...
          >
            ...
            {isBusy ? t.export.syncing : t.export.naverCalendar}
          </Button>
      ...
      {/* Result Modal */}
      <Dialog open={showModal} onOpenChange={() => reset()}>
        <DialogContent className="sm:max-w-md">
          {status === "success" && result && (
            <>
              <DialogHeader>
                <div className="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-full bg-green-100 dark:bg-green-950/50">
                  <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-green-600 dark:text-green-400"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg>
                </div>
                <DialogTitle className="text-center">
                  {t.export.modalSuccessTitle}
                </DialogTitle>
            ...
            <>
              <DialogHeader>
                <div className="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-full bg-destructive/10">
                  <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-destructive"><circle cx="12" cy="12" r="10"/><line x1="15" x2="9" y1="9" y2="15"/><line x1="9" x2="15" y1="9" y2="15"/></svg>
                </div>
                <DialogTitle className="text-center">
                  {t.export.modalErrorTitle}
                </DialogTitle>
                <DialogDescription className="text-center">
                  {error}
                </DialogDescription>
